    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <!-- Shift Roster -->
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/shift-roster*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{ translate('messages.shift_roster') }}">
                        <i class="tio-time nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.shift_roster') }}</span>
                    </a>
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/shift-roster*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('admin/shift-roster') && !Request::is('admin/shift-roster/templates') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.shift-roster.index') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.weekly_roster') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/shift-roster/templates') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.shift-roster.templates') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.shift_templates') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
