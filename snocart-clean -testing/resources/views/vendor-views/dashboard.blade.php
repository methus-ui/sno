    ...
    <div class="content container-fluid">
                    ...
                    <div class="card shadow-sm">
                        <div class="card-header bg-light border-0 pb-0">
                            <h5 class="card-title mb-0 d-flex align-items-center">
                                <i class="tio-bolt mr-2"></i> {{translate('messages.quick_actions')}}
                                <span class="badge badge-soft-primary ml-2">{{translate('messages.shortcuts')}}</span>
                            </h5>
                        </div>
                        <div class="card-body pt-3">
                            <div class="row g-2 g-md-3">
                                ...
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.item.product_gallery')}}" class="quick-action-card quick-action-featured">
                                        <div class="quick-action-icon bg-gradient-primary">
                                            <i class="tio-image"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.Product_Gallery')}}</span>
                                        <span class="quick-action-badge">{{translate('messages.new')}}</span>
                                    </a>
                                </div>

                                <!-- Add New Product -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.item.add-new')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-success">
                                            <i class="tio-add-circle"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.add_new_item')}}</span>
                                    </a>
                                </div>

                                <!-- Product List -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.item.list')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-info">
                                            <i class="tio-breakfast-dining"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.product_list')}}</span>
                                    </a>
                                </div>

                                <!-- Orders -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.order.list', ['all'])}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-warning">
                                            <i class="tio-shopping-cart-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.orders')}}</span>
                                    </a>
                                </div>

                                <!-- Reviews -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.reviews')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-danger">
                                            <i class="tio-star-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.reviews')}}</span>
                                    </a>
                                </div>

                                <!-- Coupons -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.coupon.add-new')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-purple">
                                            <i class="tio-premium-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.coupons')}}</span>
                                    </a>
                                </div>

                                <!-- Categories -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.category.add')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-teal">
                                            <i class="tio-category-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.categories')}}</span>
                                    </a>
                                </div>

                                <!-- Reports -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.report.expense-report')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-indigo">
                                            <i class="tio-chart-pie-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.reports')}}</span>
                                    </a>
                                </div>

                                <!-- Addons -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.addon.add-new')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-orange">
                                            <i class="tio-add-to-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.addons')}}</span>
                                    </a>
                                </div>

                                <!-- Store Profile -->
                                <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                    <a href="{{route('vendor.profile.view')}}" class="quick-action-card">
                                        <div class="quick-action-icon bg-gradient-pink">
                                            <i class="tio-settings-outlined"></i>
                                        </div>
                                        <span class="quick-action-text">{{translate('messages.store_settings')}}</span>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card mb-3 shadow-sm">
                ...
                <div class="row gx-2 gx-lg-3 align-items-center">
                    <div class="col-md-9">
                        <h4 class="mb-0 d-flex align-items-center">
                            <i class="tio-chart-bar-4 fz-30px mr-2 text-primary"></i>
            ...
            <div class="card-body pt-2">
                <div class="row g-2 g-md-3" id="order_stats">
