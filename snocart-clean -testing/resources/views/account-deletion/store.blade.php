...
<head>
    ...
    <title>Delete Store Account</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="logo">
            <h1>🏪 Delete Store Account</h1>
            <p>Permanently delete your store/vendor account</p>
        </div>

        <div class="warning-box">
            <h3>Before you proceed:</h3>
            <ul>
                <li>All your store data will be permanently deleted</li>
                <li>You must complete all ongoing orders first</li>
                <li>You must pay all cash in hand before deletion</li>
                <li>All your store employees will be deleted</li>
        ...
        <form id="deletionForm">
            ...
            <div id="step2" class="otp-section">
                ...
                <button type="submit" id="deleteBtn">Permanently Delete My Store Account</button>
    ...
    <script>
        ...
        sendOtpBtn.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('/account-deletion/store/request-otp', {
                    method: 'POST',
                    headers: {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            if (!confirm('Are you absolutely sure you want to delete your store account? This will delete all your stores, products, and employees. This action cannot be undone.')) {
                return;
            }
            ...
            try {
                const response = await fetch('/account-deletion/store/delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken
                ...
                deleteBtn.innerHTML = 'Permanently Delete My Store Account';
            }
        });
