                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="notification_title" id="notification_title" class="form-control" placeholder="{{translate('messages.new_notification')}}" required maxlength="191">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea name="description" id="notification_description" class="form-control" maxlength="1000" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="h-100 d-flex flex-column">
                                    ...
                                    <div class="text-center py-3 my-auto">
                                        ...
                                        src="{{ $notification && $notification->image 
                                                ? asset('storage/app/public/' . $notification->image) 
                                                : 'https://new.snocart.com/storage/app/public/notification.png' }}"
                                        alt="image"/>
                                    </div>
