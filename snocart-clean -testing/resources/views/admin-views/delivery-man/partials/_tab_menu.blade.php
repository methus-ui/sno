...
<div class="js-nav-scroller hs-nav-scroller-horizontal mt-2">
    ...
    <ul class="nav nav-tabs mb-3 border-0 nav--tabs">
        ...
        <li class="nav-item">
            <a class="nav-link {{request()?->tab == 'day_close' ? 'active' : ''}}"
                href="{{ route('admin.users.delivery-man.preview', ['id' => $deliveryMan->id, 'tab' => 'day_close']) }}"
                aria-disabled="true">{{ translate('messages.day_close') }}</a>
        </li>
    </ul>
    <!-- End Nav -->
</div>
