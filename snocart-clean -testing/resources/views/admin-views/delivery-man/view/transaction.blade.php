                    ...
                    <table id="datatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{translate('messages.actual_delivery_charge')}}</th>
                                <th class="border-0">{{translate('messages.convenience_fee')}}</th>
                        ...
                        @foreach($digital_transaction as $k=>$dt)
                            <tr>
                                ...
                                <td>{{ \App\CentralLogics\Helpers::format_currency($dt->delivery_charge ?? 0) }}</td>
                                <td>{{ \App\CentralLogics\Helpers::format_currency($dt->additional_charge ?? 0) }}</td>
