...
class Conversation extends Model
{
    ...
    {
        // Properly group the OR conditions to prevent issues with other WHERE clauses
        $query->where(function($mainQuery) use($sender_id, $receiver_id){
            $mainQuery->where(function($q) use($sender_id, $receiver_id){
