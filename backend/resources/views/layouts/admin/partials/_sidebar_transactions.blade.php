    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <li class="nav-item">
                    <small class="nav-subtitle">Incentive Management</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>
                ...
                <!-- End Incentive Management -->

                <!-- DM Performance & Shifts -->
                <li class="nav-item">
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/dm-performance/auto-assign*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.dm-performance.auto-assign.index') }}">
                        <i class="tio-flash nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Auto Assignment</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/dm-performance/sos*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.dm-performance.sos.index') }}">
                        <i class="tio-warning nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">SOS Dashboard</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/dm-performance/instant-withdrawals*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.dm-performance.instant-withdrawals.index') }}">
                        <i class="tio-money nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Instant Withdrawals</span>
                    </a>
                </li>
                <!-- End DM Performance & Shifts -->

                <!-- Payroll Extras -->
                <li class="nav-item">
                    <small class="nav-subtitle">Payroll Extras</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/fuel-incentives*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.fuel-incentives.index') }}">
                        <i class="tio-car nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Fuel Incentives</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/min-wage*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.min-wage.index') }}">
                        <i class="tio-shield-check nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Min Wage Guarantee</span>
                    </a>
                </li>
                <!-- End Payroll Extras -->
