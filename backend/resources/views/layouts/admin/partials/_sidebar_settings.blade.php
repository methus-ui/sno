...
{{--                                </li>--}}
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/system-check')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('admin.business-settings.system-check')}}"
                               title="{{translate('messages.system_check')}}">
                                <i class="tio-verified nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{translate('messages.system_check')}}
                        </span>
                            </a>
                        </li>
                    @endif
