        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- FIXED: Added missing Cashback section from file 2 -->
                    ...
                    <!-- FIXED: Product Setup - Corrected structure and proper nesting -->
                    ...
                    <li class="navbar-vertical-aside-has-menu  @yield('low_stock_list') {{ Request::is('admin/item*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/item*') ||  Request::is('admin/report/stock-report*') ? 'block' : 'none' }}">
                            ...
                            <!-- FIXED: Moved Regular Items inside the submenu where it belongs -->
                            <li class="nav-item {{ Request::is('admin/item/regular-items') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.item.regular_items') }}" title="{{ translate('messages.regular_items') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.regular_items') }}</span>
                                </a>
                            </li>
<li class="nav-item {{ Request::is('admin/item/barcode-scan') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.item.barcode_scan') }}" title="{{ translate('Barcode Scanner') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('New Store Listing ') }}</span>
                            </a>
                        </li>
