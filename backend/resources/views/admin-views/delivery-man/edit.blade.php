                    ...
                    <div class="row g-4">
                        <div class="col-lg-8">
                            ...
                            data-original-title="{{ translate('messages.Required.')}}"> *
                                ...
                                <div class="col-sm-6" id="salary_amount_field" style="{{ $deliveryMan->earning ? 'display:none' : '' }}">
                                    <div class="form-group mb-0">
                                        <label class="input-label">{{translate('messages.salary_amount')}}</label>
                                        <input type="number" step="0.01" min="0" name="salary_amount" class="form-control" value="{{ $deliveryMan->salary_amount ?? 0 }}" placeholder="{{translate('messages.salary_amount')}}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
...
<script>
    "use strict";
        $('select[name="earning"]').on('change', function() {
            $('#salary_amount_field').toggle($(this).val() == '0');
        });
