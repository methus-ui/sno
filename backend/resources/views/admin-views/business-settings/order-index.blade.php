                        ...
                        <div class="card-body">
                            <div class="py-2">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        @php($proximity_enforcement = \App\Models\BusinessSetting::where('key', 'delivery_proximity_enforcement')->first())
                                        @php($proximity_enforcement = $proximity_enforcement ? $proximity_enforcement->value : 1)
                                        <div class="form-group mb-0">
                                            <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control">
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    <span class="line--limit-1">
                                                        {{ translate('messages.delivery_proximity_enforcement') }}
                                                    </span>
                                                    <span class="form-label-secondary text-danger d-flex"
                                                        data-toggle="tooltip" data-placement="right"
                                                        data-original-title="{{ translate('messages.delivery_man_must_be_within_set_radius_to_complete_delivery') }}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('messages.delivery_proximity_enforcement') }}">
                                                    </span>
                                                </span>
                                                <input type="checkbox" class="toggle-switch-input" value="1"
                                                    name="delivery_proximity_enforcement" id="delivery_proximity_enforcement"
                                                    {{ $proximity_enforcement == 1 ? 'checked' : '' }}>
                                                <span class="toggle-switch-label text">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                        @php($proximity_radius = \App\Models\BusinessSetting::where('key', 'delivery_proximity_radius')->first())
                                        @php($proximity_radius = $proximity_radius ? $proximity_radius->value * 1000 : 200)
                                        <div class="form-group mb-0">
                                            <label class="input-label" for="delivery_proximity_radius">
                                                {{ translate('messages.delivery_proximity_radius') }} ({{ translate('messages.meters') }})
                                                <span class="form-label-secondary text-danger d-flex"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="{{ translate('messages.how_close_dm_must_be_to_complete_delivery') }}">
                                                    <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="">
                                                </span>
                                            </label>
                                            <input type="number" name="delivery_proximity_radius" id="delivery_proximity_radius"
                                                class="form-control h--45px" value="{{ $proximity_radius }}"
