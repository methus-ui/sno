        ...
        <div class="container">
            <div class="page-hero-inner">
                <div class="since-badge">
                    ...
                    <span>Your Privacy Matters — Since 2021</span>
                </div>
                <h1>{{translate('messages.privacy_policy')}}</h1>
                <p class="lead">We are committed to protecting your personal information and being transparent about how we collect, use, and safeguard your data.</p>
            </div>
        </div>
    </section>
