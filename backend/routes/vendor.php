    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'dashboard', 'as' => 'dashboard.'], function () {
            Route::post('order-stats', 'DashboardController@order_stats')->name('order-stats');
                     Route::get('cart-data', 'DashboardController@getCartData')->name('cart-data');
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item' ,'subscription:item']], function () {
            ...
            Route::post('search-by-barcode', 'ItemController@searchByBarcode')->name('search-by-barcode');
        ...
        Route::group(['prefix' => 'wallet', 'as' => 'wallet.', 'middleware' => ['module:wallet' ,'subscription:wallet']], function () {
            ...
            Route::post('make-wallet-adjustment', 'WalletController@make_wallet_adjustment')->name('vendor_panel.make_wallet_adjustment');

            Route::get('wallet-payment-list', 'WalletController@wallet_payment_list')->name('vendor_panel.wallet_payment_list');
