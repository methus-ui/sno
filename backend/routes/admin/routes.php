...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        Route::post('gemini/generate-notification', [GeminiController::class, 'generateNotification'])->name('gemini.generate-notification');
    });
    ...
    Route::group(['middleware' => ['admin', 'current-module']], function () {
        ...
        Route::group([ 'prefix' => 'advertisement', 'as' => 'advertisement.' ,'middleware' => ['module:advertisement']], function () {
            ...
            Route::get('/instagram-reels', [AdvertisementController::class,'getInstagramReels'])->name('instagram.reels');
            Route::post('/instagram-connect', [AdvertisementController::class,'connectInstagram'])->name('instagram.connect');
            Route::post('/instagram-disconnect', [AdvertisementController::class,'disconnectInstagram'])->name('instagram.disconnect');
            Route::get('/instagram-reel-details', [AdvertisementController::class,'getReelDetails'])->name('instagram.reel.details');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'zone', 'as' => 'zone.', 'middleware' => ['module:zone']], function () {
                ...
                // Delivery Fee Schedule Routes
                Route::group(['prefix' => 'delivery-fee-schedule', 'as' => 'delivery-fee-schedule.'], function () {
                    Route::get('/{zoneId}', [\App\Http\Controllers\Admin\Zone\ZoneDeliveryFeeScheduleController::class, 'index'])->name('index');
                    Route::post('/{zoneId}', [\App\Http\Controllers\Admin\Zone\ZoneDeliveryFeeScheduleController::class, 'store'])->name('store');
                    Route::put('/{id}', [\App\Http\Controllers\Admin\Zone\ZoneDeliveryFeeScheduleController::class, 'update'])->name('update');
                    Route::get('/status/{id}/{status}', [\App\Http\Controllers\Admin\Zone\ZoneDeliveryFeeScheduleController::class, 'updateStatus'])->name('status');
                    Route::delete('/{id}', [\App\Http\Controllers\Admin\Zone\ZoneDeliveryFeeScheduleController::class, 'destroy'])->name('destroy');
                });

                // Weather Surge Routes
                Route::group(['prefix' => 'weather-surge', 'as' => 'weather-surge.'], function () {
                    Route::get('/{zoneId}', [\App\Http\Controllers\Admin\Zone\WeatherSurgeController::class, 'index'])->name('index');
                    Route::post('/{zoneId}', [\App\Http\Controllers\Admin\Zone\WeatherSurgeController::class, 'store'])->name('store');
                    Route::put('/{id}', [\App\Http\Controllers\Admin\Zone\WeatherSurgeController::class, 'update'])->name('update');
                    Route::get('/status/{id}/{status}', [\App\Http\Controllers\Admin\Zone\WeatherSurgeController::class, 'updateStatus'])->name('status');
                    Route::delete('/{id}', [\App\Http\Controllers\Admin\Zone\WeatherSurgeController::class, 'destroy'])->name('destroy');
                });

                // Demand Surge Routes
                Route::group(['prefix' => 'demand-surge', 'as' => 'demand-surge.'], function () {
                    Route::get('/{zoneId}', [\App\Http\Controllers\Admin\Zone\DemandSurgeController::class, 'index'])->name('index');
                    Route::post('/{zoneId}', [\App\Http\Controllers\Admin\Zone\DemandSurgeController::class, 'store'])->name('store');
                    Route::put('/{id}', [\App\Http\Controllers\Admin\Zone\DemandSurgeController::class, 'update'])->name('update');
                    Route::get('/status/{id}/{status}', [\App\Http\Controllers\Admin\Zone\DemandSurgeController::class, 'updateStatus'])->name('status');
                    Route::delete('/{id}', [\App\Http\Controllers\Admin\Zone\DemandSurgeController::class, 'destroy'])->name('destroy');
                });
            });
        ...
        Route::group(['prefix' => 'users', 'as' => 'users.'], function () {
            ...
            Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
                ...
                Route::group(['middleware' => ['module:deliveryman']], function () {
                    ...
                    Route::post(DeliveryMan::DAY_CLOSE[URI], [DeliveryManController::class, 'postDayClose'])->name('day-close');
                    Route::get(DeliveryMan::DAY_CLOSE_EXPORT[URI], [DeliveryManController::class, 'getDayCloseExport'])->name('day-close-export');
