    ...
    <aside class="js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered  ">
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <!-- WhatsApp Campaigns -->
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/whatsapp*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.whatsapp.index') }}" title="WhatsApp Campaigns">
                        <i class="fab fa-whatsapp nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">WhatsApp Campaigns</span>
                    </a>
                </li>
                <!-- End WhatsApp Campaigns -->

                <!-- Bargaining Mode -->
                @if (\App\CentralLogics\Helpers::module_permission_check('order'))
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/bargaining*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{ translate('bargaining_mode') }}">
                        <i class="tio-price-tags nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('bargaining_mode') }}</span>
                    </a>
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/bargaining*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('admin/bargaining/dashboard') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.bargaining.dashboard') }}" title="{{ translate('dashboard') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('dashboard') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/bargaining/requests') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.bargaining.requests') }}" title="{{ translate('bargaining_requests') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <li class="nav-item {{ Request::is('admin/bargaining/analytics') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.bargaining.analytics') }}" title="{{ translate('analytics') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('analytics') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/bargaining/settings') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.bargaining.settings') }}" title="{{ translate('settings') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                ...
                <!-- End marketing section -->
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/dispatch/*') ? 'active' : '' }}">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="{{ Request::is('admin/dispatch*') ? 'display-block' : 'display-none' }}">
                            <li class="nav-item {{ Request::is('admin/dispatch/unified') ? 'active' : '' }}">
                                <a class="nav-link font-weight-bold" href="{{ route('admin.dispatch.unified') }}" title="Unified Dispatch Management" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white !important; border-radius: 8px; padding: 10px;">
                                    <span class="tio-dashboard nav-indicator-icon"></span>
                                    <span class="text-truncate">
                                        <i class="tio-star"></i> 🚀 UNIFIED DISPATCH (NEW)
                                    </span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::is('admin/dispatch/list/all/searching_for_deliverymen') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.dispatch.list', ['all', 'searching_for_deliverymen']) }}" title="{{ translate('messages.all_unassigned_orders') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <i class="tio-apps"></i> {{translate('messages.all')}} {{translate('messages.unassigned_orders')}}
                                        <span class="badge badge-soft-info badge-pill ml-1">
                            ...
                            <li class="nav-item {{ Request::is('admin/dispatch/list/all/on_going') ? 'active' : '' }}">
                                <a class="nav-link " href="{{ route('admin.dispatch.list', ['all', 'on_going']) }}" title="{{ translate('messages.all_ongoing_orders') }}">
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate sidebar--badge-container">
                                        <i class="tio-apps"></i> {{translate('messages.all')}} {{ translate('messages.ongoingOrders') }}
                ...
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/deliveryman/security-deposit*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{ translate('messages.security_deposit') }}">
                        <i class="tio-money nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.security_deposit') }}
                        </span>
                    </a>
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: none">
                        <li class="nav-item {{ Request::is('admin/deliveryman/security-deposit/settings') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.deliveryman.security-deposit.settings') }}" title="{{ translate('messages.settings') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.settings') }}</span>
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/deliveryman/security-deposit') && !Request::is('admin/deliveryman/security-deposit/settings') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.deliveryman.security-deposit.index') }}" title="{{ translate('messages.payment_list') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">{{ translate('messages.payment_list') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/deliveryman/offline-monitor*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.deliveryman.offline-monitor.index') }}" title="{{ translate('messages.offline_monitor') }}">
                        <i class="tio-time nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.offline_monitor') }}
                        </span>
                    </a>
                </li>
                @endif
                ...
                <!-- Payroll Section -->
                <li class="nav-item">
                    <small class="nav-subtitle" title="{{ translate('messages.payroll') }}">{{ translate('messages.payroll_management') }}</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.index') }}" title="{{ translate('messages.payroll') }}">
                        <i class="tio-wallet nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.payroll_list') }}
                        </span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/generate') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.generate') }}" title="{{ translate('messages.generate_payroll') }}">
                        <i class="tio-add-circle nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.generate_payroll') }}
                        </span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/incentive-slabs*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.incentive-slabs.index') }}" title="{{ translate('messages.incentive_slabs') }}">
                        <i class="tio-star nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.incentive_slabs') }}
                        </span>
                    </a>
                </li>
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/daily-incentives*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.daily-incentives.index') }}">
                        <i class="tio-trending-up nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Daily Incentive Rules</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/time-incentives*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.time-incentives.index') }}">
                        <i class="tio-clock nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Time-Based Incentives</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/payroll/rush-incentives*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.payroll.rush-incentives.index') }}">
                        <i class="tio-flash nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Rush / Surge Incentives</span>
                    </a>
                </li>

                <!-- End Payroll -->

                <!-- Performance & Shifts Section -->
                <li class="nav-item">
                    <small class="nav-subtitle">DM Performance & Shifts</small>
                    <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/dm-performance/tiers*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.dm-performance.tiers.index') }}">
                        <i class="tio-medal nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Performance Tiers</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/dm-performance/leaderboard*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.dm-performance.leaderboard.index') }}">
                        <i class="tio-trophy nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Leaderboard</span>
                    </a>
                </li>

                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/dm-performance/shifts*') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.transactions.dm-performance.shifts.index') }}">
                        <i class="tio-calendar nav-icon"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Shift Management</span>
                    </a>
                </li>
                <!-- End Performance & Shifts -->
                ...
                <li
                class="navbar-vertical-aside-has-menu {{ Request::is('admin/chat') ? 'active' : '' }}">
                ...
                {{-- Employee Applications (Super Admin Only) --}}
                @if (auth('admin')->check() && auth('admin')->user()->role_id === 1)
                @php
                    $pendingAdminCount = \App\Models\Admin::pending()->where('role_id', '!=', 1)->count();
                    $pendingVendorCount = \App\Models\VendorEmployee::pending()->count();
                    $totalPendingCount = $pendingAdminCount + $pendingVendorCount;
                @endphp
                <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/employee-application*') ? 'active' : '' }} {{ $totalPendingCount > 0 ? 'has-pending-applications' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="{{ translate('messages.employee_applications') }}">
                        <i class="tio-user-add nav-icon {{ $totalPendingCount > 0 ? 'text-warning' : '' }}"></i>
                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                            {{ translate('messages.employee_applications') }}
                            @if($totalPendingCount > 0)
                                <span class="badge badge-danger badge-pill ml-1" style="animation: pulse 2s infinite;">{{ $totalPendingCount }}</span>
                            @endif
                        </span>
                    </a>
                    <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display:{{ Request::is('admin/employee-application*') ? 'block' : 'none' }}">
                        <li class="nav-item {{ Request::is('admin/employee-application') && request()->type === 'admin' ? 'active' : '' }}">
                            <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.employee-application.list', ['type' => 'admin']) }}" title="{{ translate('messages.admin_applications') }}">
                                <span>
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.admin_applications') }}</span>
                                </span>
                                @if($pendingAdminCount > 0)
                                    <span class="badge badge-soft-warning badge-pill">{{ $pendingAdminCount }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/employee-application') && request()->type === 'vendor' ? 'active' : '' }}">
                            <a class="nav-link d-flex justify-content-between align-items-center" href="{{ route('admin.employee-application.list', ['type' => 'vendor']) }}" title="{{ translate('messages.vendor_applications') }}">
                                <span>
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">{{ translate('messages.vendor_applications') }}</span>
                                </span>
                                @if($pendingVendorCount > 0)
                                    <span class="badge badge-soft-warning badge-pill">{{ $pendingVendorCount }}</span>
                                @endif
                            </a>
                        </li>
                        <li class="nav-item {{ Request::is('admin/employee-application/invite') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.employee-application.invite') }}" title="{{ translate('messages.send_invitation') }}">
                                <span class="tio-circle nav-indicator-icon"></span>
                                <span class="text-truncate">
                                    <i class="tio-email-outlined"></i>
                                    {{ translate('messages.send_invitation') }}
                                </span>
                            </a>
                        </li>
                    </ul>
...
@push('css_or_js')
<style>
    /* Pulse animation for employee application pending badge */
    @keyframes pulse {
        0%, 100% {
            transform: scale(1);
            opacity: 1;
    ...
    /* Highlight employee applications menu when pending */
    .navbar-vertical-aside-has-menu.has-pending-applications {
