...
@section('title', translate('messages.attendance_report'))
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title">{{translate('messages.attendance_report')}}</h1>
                <p class="page-header-text">{{translate('messages.export_employee_attendance_data')}}</p>
            </div>
        </div>
    </div>
    <!-- End Page Header -->
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="employee_id" id="employee_id" class="form-control">
                                        ...
                                        <option value="{{$employee->id}}">
                                            {{$employee->f_name}} {{$employee->l_name}} (ID: {{$employee->id}})
                                        </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="media align-items-center">
                                <div class="media-body ml-3">
                                    ...
                                    <small class="d-block text-muted">{{translate('messages.total_employees')}}</small>
                                </div>
