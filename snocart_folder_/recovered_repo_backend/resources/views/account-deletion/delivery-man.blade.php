...
<head>
    ...
    <title>Delete Delivery Man Account</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="logo">
            <h1>🛵 Delete Delivery Man Account</h1>
            <p>Permanently delete your delivery man account</p>
        </div>
    ...
    <script>
        ...
        sendOtpBtn.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('/account-deletion/delivery-man/request-otp', {
                    method: 'POST',
                    headers: {
        ...
        form.addEventListener('submit', async function(e) {
            ...
            if (!confirm('Are you absolutely sure you want to delete your delivery man account? This action cannot be undone.')) {
                return;
            }
            ...
            try {
                const response = await fetch('/account-deletion/delivery-man/delete', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': csrfToken
