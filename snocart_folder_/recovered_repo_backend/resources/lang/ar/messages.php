<?php return array (
  ...
  'adding' => 'جاري الإضافة...',
  'please_select_required_variations' => 'الرجاء تحديد جميع الخيارات المطلوبة',
  'failed_to_add_item' => 'فشل في إضافة العنصر إلى السلة',
  'admin' => 'مسؤل',
  ...
  // Phase 1
  'daily_incentive_rules' => 'قواعد الحوافز اليومية',
  'add_daily_incentive_rule' => 'إضافة قاعدة حافز يومي',
  'time_based_incentives' => 'الحوافز المبنية على الوقت',
  'rush_incentives' => 'حوافز الذروة',

  // Phase 2
  'auto_assignment_settings' => 'إعدادات التعيين التلقائي',
  'add_update_setting' => 'إضافة / تحديث الإعداد',
  'all_zones' => 'جميع المناطق',
  'max_radius_km' => 'أقصى نطاق (كم)',
  'max_radius' => 'أقصى نطاق',
  'fallback_seconds' => 'الرجوع (ثواني)',
  'fallback' => 'الرجوع',
  'max_orders_per_dm' => 'أقصى طلبات لكل سائق',
  'max_orders' => 'أقصى طلبات',
  'enabled' => 'مفعّل',
  'enable' => 'تفعيل',
  'priority_weights' => 'أوزان الأولوية',
  'must_sum_to_1' => 'يجب أن يساوي المجموع 1',
  'distance_weight' => 'وزن المسافة',
  'rating_weight' => 'وزن التقييم',
  'acceptance_rate_weight' => 'وزن معدل القبول',
  'tier_weight' => 'وزن المستوى',
  'current_settings' => 'الإعدادات الحالية',
  'sos_dashboard' => 'لوحة الطوارئ',
  'resolve' => 'حل',
  'resolved' => 'تم الحل',
  'instant_withdrawals' => 'السحب الفوري',
  'requested_at' => 'تاريخ الطلب',
  'approve' => 'موافقة',
  'reject' => 'رفض',
  'fuel_incentives' => 'حوافز الوقود',
  'add_fuel_incentive' => 'إضافة حافز وقود',
  'rate_per_km' => 'السعر لكل كم',
  'fuel_price_ref' => 'مرجع سعر الوقود',
  'effective_from' => 'ساري من',
  'effective_to' => 'ساري حتى',
  'minimum_wage_guarantee' => 'ضمان الحد الأدنى للأجور',
  'configure_minimum_wage' => 'تكوين الحد الأدنى للأجور',
  'dm_type' => 'نوع السائق',
  'min_daily_amount' => 'الحد الأدنى اليومي',
  'min_hours_required' => 'الحد الأدنى للساعات المطلوبة',
  'min_amount' => 'الحد الأدنى للمبلغ',
  'min_hours' => 'الحد الأدنى للساعات',
  'wage_adjustments' => 'تعديلات الأجور',
  'earned' => 'المكتسب',
  'guaranteed' => 'المضمون',
  'adjustment' => 'التعديل',
  'hours' => 'ساعات',
  'weather_surge_rule_created' => 'تم إنشاء قاعدة زيادة الطقس بنجاح',
  'weather_surge_rule_updated' => 'تم تحديث قاعدة زيادة الطقس بنجاح',
  'weather_surge_rule_deleted' => 'تم حذف قاعدة زيادة الطقس بنجاح',
  'demand_surge_level_created' => 'تم إنشاء مستوى زيادة الطلب بنجاح',
  'demand_surge_level_updated' => 'تم تحديث مستوى زيادة الطلب بنجاح',
  'demand_surge_level_deleted' => 'تم حذف مستوى زيادة الطلب بنجاح',
  'compare_bill_cart' => 'قارن الفاتورة مع السلة',
  'compare' => 'قارن',
  'bill_vs_cart_comparison' => 'مقارنة الفاتورة مع السلة',
  'zoom_in' => 'تكبير',
  'zoom_out' => 'تصغير',
  ...
  'view_bill_qr' => 'مسح رمز الاستجابة السريعة لعرض الفاتورة',
  'bill_images' => 'صور الفاتورة',
  ...
  'server_error_contact_support' => 'خطأ في الخادم. اتصل بالدعم.',
  'unexpected_error' => 'خطأ غير متوقع.',
  'unsaved_changes_warning' => 'لديك تغييرات غير محفوظة. هل أنت متأكد أنك تريد المغادرة؟',
  'search_failed' => 'فشل البحث.',
  'error_loading_catalog' => 'خطأ في تحميل الكتالوج.',
  'please_select_variation_options' => 'يرجى تحديد خيارات التنوع.',
  'error_adding_item' => 'خطأ في إضافة العنصر.',
  'failed_to_update_quantity' => 'فشل تحديث الكمية. يرجى المحاولة مرة أخرى.',
  'could_not_remove_item' => 'تعذرت إزالة العنصر.',
  'no_change' => 'لا توجد تغييرات',
  'item_marked_unavailable' => 'تم وضع علامة على العنصر كغير متاح.',
  'item_marked_available' => 'تم وضع علامة على العنصر كمتاح.',
  'failed_to_update_item' => 'فشل تحديث العنصر.',
  'please_enter_valid_cost' => 'يرجى إدخال تكلفة شراء صحيحة.',
  'outside_purchase_recorded' => 'تم تسجيل الشراء الخارجي.',
  'failed' => 'فشل',
  'approved' => 'تمت الموافقة',
  'rejected' => 'مرفوض',
  'please_enter_valid_price' => 'يرجى إدخال سعر صحيح.',
  'price_updated' => 'تم تحديث السعر.',
  'mrp_approved' => 'تمت الموافقة على السعر.',
  'mrp_rejected' => 'تم رفض السعر.',
  'no_product_found_for_barcode' => 'لم يتم العثور على منتج للباركود',
