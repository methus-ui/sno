...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::middleware('api')
                ->namespace($this->namespace)
                ->group(base_path('routes/delivery_qr_api.php'));

            // Employee Chat API routes
            Route::prefix('api/v1')
                ->middleware('api')
                ->namespace($this->namespace)
                ->group(base_path('routes/api/v1/employee-chat.php'));
        });
    }
    ...
    protected function configureRateLimiting()
    {
        ...
        // Chat API rate limiting - general read operations
        ...
        // Template usage tracking - prevent spam
        RateLimiter::for('chat-templates', function (Request $request) {
        ...
        // Polling endpoint - allow more frequent requests but still limited
