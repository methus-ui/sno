...
'websocket_port' => (int)(isset($settings['websocket_port']) ? $settings['websocket_port'] : 6001),
            'websocket_key_debug' => $settings['websocket_key'] ?? 'NOT_SET',  // ADD THIS LINE
            'websocket_key' => (isset($settings['websocket_key']) ? $settings['websocket_key'] : config('broadcasting.connections.pusher.key')),
