...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\SecurityHeaders::class, // Add security headers to all web requests
        ],
    ...
    protected $routeMiddleware = [
        ...
        // Security Fix (2026-01-28): External API authentication middleware
        'external.api' => \App\Http\Middleware\ExternalApiAuth::class,
        'super-admin' => \App\Http\Middleware\SuperAdminMiddleware::class,
        // Bargaining Mode (2026-03-17)
        'bargaining_enabled' => \App\Http\Middleware\BargainingEnabled::class,
        'vendor_employee' => \App\Http\Middleware\VendorMiddleware::class, // Reuse vendor middleware for vendor employee auth
